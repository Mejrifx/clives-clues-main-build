-- Final fix for unlock_blog function
...
DECLARE
    func_record RECORD;
BEGIN
    -- Get all unlock_blog functions regardless of signature
    FOR func_record IN 
        SELECT schemaname, proname, oidvectortypes(proargtypes) as argtypes
        FROM pg_proc p
        JOIN pg_namespace n ON p.pronamespace = n.oid
        WHERE proname LIKE 'unlock_blog%' AND n.nspname = 'public'
    LOOP
